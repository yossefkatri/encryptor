...
public class EncryptionStartedEvent extends EventObject {
     ...
     */
    public EncryptionStartedEvent(Object source, LocalDateTime endTime, String encryptionAlgorithmName, Path decryptedFile, Path encryptedFile, String key, Boolean isFile) {
        super(source);
